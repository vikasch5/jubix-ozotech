                        ...
                        <div class="brands-swiper swiper-container swiper-theme "
                            ...
                            <div class="swiper-wrapper row gutter-no cols-xl-7 cols-lg-6 cols-md-4 cols-sm-3 cols-2">
                                <div class="swiper-slide">
                                    <figure>
                                        <img src="{{ asset('frontend/images/brands/category/1.png')}}" alt="Brand" width="160" height="90" />
                                    </figure>
                                </div>
                                <div class="swiper-slide">
                                    <figure>
                                        <img src="{{ asset('frontend/images/brands/category/2.png')}}" alt="Brand" width="160" height="90" />
                                    </figure>
                                </div>
                                <div class="swiper-slide">
                                    <figure>
                                        <img src="{{ asset('frontend/images/brands/category/3.png')}}" alt="Brand" width="160" height="90" />
                                    </figure>
                                </div>
                                <div class="swiper-slide">
                                    <figure>
                                        <img src="{{ asset('frontend/images/brands/category/4.png')}}" alt="Brand" width="160" height="90" />
                                    </figure>
                                </div>
                                <div class="swiper-slide">
                                    <figure>
                                        <img src="{{ asset('frontend/images/brands/category/5.png')}}" alt="Brand" width="160" height="90" />
                                    </figure>
                                </div>
                                <div class="swiper-slide">
                                    <figure>
                                        <img src="{{ asset('frontend/images/brands/category/6.png')}}" alt="Brand" width="160" height="90" />
                                    </figure>
                                </div>
                                <div class="swiper-slide">
                                    <figure>
                                        <img src="{{ asset('frontend/images/brands/category/7.png')}}" alt="Brand" width="160" height="90" />
                                    </figure>
                                </div>
                            </div>
                            ...
                            <div class="swiper-wrapper row gutter-lg cols-xl-8 cols-lg-7 cols-md-6 cols-sm-4 cols-xs-3 cols-2">
                                    ...
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="{{ asset('frontend/images/categories/category-4.jpg')}}" alt="Categroy"
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="{{ asset('frontend/images/categories/category-5.jpg')}}" alt="Categroy"
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="{{ asset('frontend/images/categories/category-6.jpg')}}" alt="Categroy"
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="{{ asset('frontend/images/categories/category-7.jpg')}}" alt="Categroy"
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="{{ asset('frontend/images/categories/category-8.jpg')}}" alt="Categroy"
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="{{ asset('frontend/images/categories/category-9.jpg')}}" alt="Categroy"
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="{{ asset('frontend/images/categories/category-20.jpg')}}" alt="Categroy"
                                ...
                                <div class="swiper-slide category-wrap">
                                    <div class="category category-ellipse">
                                        <figure class="category-media">
                                            <a href="shop-banner-sidebar.html">
                                                <img src="{{ asset('frontend/images/categories/category-21.jpg')}}" alt="Categroy"
                                ...
                                <div class="sticky-sidebar">
                                    ...
                                    <div class="widget widget-collapsible">
                                        ...
                                        <ul class="widget-body filter-items search-ul">
                                            ...
                                            <li><a href="{{ $subCategory->id }}">{{ $subCategory->sub_category_name }}</a></li>
                                            @endforeach
                                        </ul>
                                    </div>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{ asset('frontend/images/shop/1.jpg')}}" alt="Product" width="300"
                                                    height="338" />
                                            </a>
