        ...
        <div class="container">
            <div class="header-left mr-md-4 justify-content-between">
                ...
                <a href="{{ route('home') }}" class="logo ml-lg-0">
                    <img style="height:60px;width:auto" src="https://ozotechsolutions.com/website/file/header_logo.jpg"
                            ...
                            @if($categories->count() > '0')
                                <ul>
                                    @foreach ($categories as $category)
                                        <li><a href="{{ route('service.details',$category->slug) }}">{{ $category->category_name }}</a></li>
                                    @endforeach
                                </ul>
                            @endif
                        </li>
