            ...
            {{-- <div class="header-top">
                <div class="container">
                    ...
                    <div class="header-right pr-0">
                        ...
                        <a href="frontend/ajax/login.html" class="d-lg-show login sign-in"><i
                ...
                <div class="container">
                    <div class="header-left mr-md-4 justify-content-between">
                        ...
                        <a href="{{ route('home') }}" class="logo ml-lg-0">
                            <img style="height:60px;width:auto" src="https://ozotechsolutions.com/website/file/header_logo.jpg" alt="logo" width="144" height="45" />
                        </a>
                        <nav class="main-nav">
                            <ul class="menu">
                                <li class="">
                        ...
                        {{-- <div class="header-call d-xs-show d-lg-flex align-items-center">
                            ...
                            <div class="call-info d-xl-show">
                                <h4 class="chat font-weight-normal font-size-md text-normal ls-normal text-light mb-0">
                                    <a href="https://portotheme.com/cdn-cgi/l/email-protection#c8eb" class="text-capitalize">Live Chat</a> or :</h4>
