                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="right-btn">
                                <a href="{{ route('admin.sub.category.add') }}"
                                    class="btn btn-primary-light btn-wave me-2 waves-effect waves-light">Add Sub
                                    Category</a>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="hidden" id="delete_url"
                                                        value="{{ route('admin.sub.category.delete') }}">
                                                    <div class="hstack gap-2 fs-15">
                                                        <a href="{{ route('admin.sub.category.add', $category->id) }}"
