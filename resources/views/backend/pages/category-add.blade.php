            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card custom-card overflow-hidden">
                        ...
                        <div class="card-body">
                            <form id="categoryForm" class="ajaxForm" action="{{ route('admin.category.store-or-update') }}"
                                method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="category_id" value="{{ optional($category)->id }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="category_name" class="form-control required"
                                            value="{{ optional($category)->category_name }}" placeholder="Category Name">
                                        @error('category_name')
