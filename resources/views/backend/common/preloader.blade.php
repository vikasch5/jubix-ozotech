        ...
        <div class="offcanvas-body">
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="d-flex justify-content-between canvas-footer flex-nowrap gap-2">
                    <a href="https://sprukomarket.com/items/zynix-bootstrap-laravel-admin-panel-template/54604"
                        target="_blank" class="btn btn-primary text-nowrap">Buy Now</a>
                    <a href="https://1.envato.market/MGEaN" target="_blank" class="btn btn-secondary text-nowrap">Our
                        Portfolio</a>
